(ns operation-win-scrabble.services.anagram
...
(def dict "Path to our official word list."
  "resources/public/words/dict/OWL2.txt")

(def word-files-of-interest
  "A list of word files of high-value scrabble words."
  ["resources/public/words/lists/2-letter-words.txt"
   "resources/public/words/lists/3-letter-words.txt"
   "resources/public/words/lists/4-letters-3-vowels.txt"
   "resources/public/words/lists/5-letters-4-vowels.txt"
   "resources/public/words/lists/all-consts.txt"
   "resources/public/words/lists/q-words-no-qu.txt"
   "resources/public/words/lists/up-to-4-letter-j-words.txt"
   "resources/public/words/lists/up-to-4-letter-x-words.txt"
   "resources/public/words/lists/up-to-4-letter-z-words.txt"
   "resources/public/words/lists/up-to-5-letter-q-words.txt"])
